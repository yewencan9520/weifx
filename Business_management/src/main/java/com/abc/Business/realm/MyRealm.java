package com.abc.Business.realm;
...
//        simpleAuthorizationInfo.addRole(role);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
         ...
         * 参数3：realm的名称：唯一
         */
        SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(user.getLoginName(),user.getLoginPwd(),getName());
