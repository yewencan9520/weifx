    ...
    if (ele.tagName.toLowerCase() == "script") {
        ...
        if (isIE && ele.offsetWidth == 0 && ele.offsetHeight == 0) {
            ...
            if (isBorderBox) {
                ...
                dim = {
                    width: +curStyle.pixelWidth + parseInt(curStyle.borderLeftWidth) + parseInt(curStyle.borderRightWidth) + parseInt(curStyle.paddingLeft) + parseInt(curStyle.paddingRight),
