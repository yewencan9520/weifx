...
//        simpleAuthorizationInfo.addRole(role);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        WxbCustomer customer = userDao.findUser(username);
        //参数1：用户名/参数2：密码/参数3：realm的名称：唯一
        SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(customer.getLoginName(),customer.getLoginPwd(),"myRealm");
