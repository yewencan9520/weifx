...
var provinceList = [
{name:'北京', cityList:[		   
{name:'北京(市辖区)', areaList:['东城区','西城区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区']},
{name:'北京(县)', areaList:['密云县','延庆县']}
]},
{name:'上海', cityList:[		   
{name:'上海(市辖区)', areaList:['黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','南汇区','奉贤区']},
{name:'上海(县)', areaList:['崇明县']}
]},
{name:'天津', cityList:[		   
{name:'天津(市辖区)', areaList:['和平区','河东区','河西区','南开区','河北区','红桥区','塘沽区','汉沽区','大港区','东丽区','西青区','津南区','北辰区','武清区','宝坻区']},
{name:'天津(县)', areaList:['宁河县','静海县','蓟　县']}
]},
{name:'重庆', cityList:[		   
{name:'重庆(市辖区)', areaList:['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区']},
{name:'重庆(县)', areaList:['綦江县','潼南县','铜梁县','大足县','荣昌县','璧山县','梁平县','城口县','丰都县','垫江县','武隆县','忠　县','开　县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县']},
{name:'重庆(市)', areaList:['江津市','合川市','永川市','南川市']}
]},
{name:'四川', cityList:[		   
...
function showProvinces() {
	...
	for(var i=0;i<provinceList.length;i++){
		...
		var optionStr = "<option value='"+province.name+"'>"+province.name+"</option>";
...
//显示指定省份下的城市
function showCities(provinceName) {
	//获取当前省份下的城市列表
    var cityList = [];
    for(var i=0;i<provinceList.length;i++){
        var province = provinceList[i];
    ...
    for (var i=0;i<cityList.length;i++){
    	var city = cityList[i];
        var optionStr = "<option value='"+city.name+"'>"+city.name+"</option>";
...
$("#city").change(function () {
    ...
    //显示当前城市下的区
    showAreas(selectedCity);
});

function showAreas(cityName) {
	//获取城市下的区
	var areaList = [];
    for(var i=0;i<provinceList.length;i++){
        var province = provinceList[i];
        ...
        var flag = false;
		for(var j=0;j<cityList.length && flag==false;j++){
			var city = cityList[j];
	...
	for (var i=0;i<areaList.length;i++){
		var area = areaList[i];
        var optionStr = "<option value='"+area+"'>"+area+"</option>";
